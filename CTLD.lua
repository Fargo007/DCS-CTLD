...
--[BSD]Fargo
ctld.troopWeight = 100   -- Weight of a single infantry soldier for extraction in weight modeling. Set to zero to disable.
ctld.heliWeights = { }						 
...
function ctld.checkTroopStatus(_args)
    ...
    local _onboard = ctld.inTransitTroops[_heli:getName()]
    local weight = ctld.heliWeights[_heli:getName()] --Fargo
